...
/* 0xE_ */      ld_ff00u8_a,    pop_hl,         ld_ff00c_a,     error,          error,          push_hl,        and_a_u8,       error,          error,          error,          ld_u16ind_a,    error,          error,          error,          xor_a_u8,       error,
/* 0xF_ */      ld_a_ff00u8,    pop_af,         ld_a_ff00c,     error,          error,          push_af,        or_a_u8,        error,          error,          ld_sp_hl,       ld_a_u16ind,    error,          error,          error,          cp_a_u8,        error,
            ],
