...
/* 0x1_ */      error,          ld_de_u16,      ld_deind_a,     inc_de,         inc_d,          dec_d,          ld_d_u8,        error,          error,          add_hl_de,      ld_a_deind,     dec_de,          inc_e,          dec_e,          ld_e_u8,        error,
...
/* 0xC_ */      error,          pop_bc,         error,          error,          error,          push_bc,        add_a_u8,       error,          error,          error,          error,          error,          error,          error,          adc_a_u8,       error,
...
/* 0xF_ */      ld_a_ff00u8,    pop_af,         ld_a_ff00c,     error,          error,          push_af,        or_a_u8,        error,          ld_hl_sp_i8,    ld_sp_hl,       ld_a_u16ind,    error,          error,          error,          cp_a_u8,        error,
            ],
