...
/* 0x0_ */      nop,            ld_bc_u16,      ld_bcind_a,     error,          error,          error,          ld_b_u8,        error,          ld_u16ind_sp,   error,          ld_a_bcind,     error,          error,          error,          ld_c_u8,        error,
/* 0x1_ */      error,          ld_de_u16,      ld_deind_a,     error,          error,          error,          ld_d_u8,        error,          error,          error,          ld_a_deind,     error,          error,          error,          ld_e_u8,        error,
/* 0x2_ */      error,          ld_hl_u16,      ld_hlindinc_a,  error,          error,          error,          ld_h_u8,        error,          error,          error,          ld_a_hlindinc,  error,          error,          error,          ld_l_u8,        error,
/* 0x3_ */      error,          ld_sp_u16,      ld_hlinddec_a,  error,          error,          error,          ld_hlind_u8,    error,          error,          error,          ld_a_hlinddec,  error,          error,          error,          ld_a_u8,        error,
...
/* 0x8_ */      error,          error,          error,          error,          error,          error,          error,          error,          error,          error,          error,          error,          error,          error,          error,          error,
